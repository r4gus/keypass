...
pub const accent = Color{ .r = 0, .g = 129, .b = 112 }; //Color{ .r = 0xa0, .g = 0xe7, .b = 0xe5, .a = 210 };
pub const success = Color{ .r = 0xb4, .g = 0xf8, .b = 0xc8, .a = 210 };
pub const err = Color{ .r = 204, .g = 2, .b = 2 };
pub const control = Color{ .r = 0, .g = 91, .b = 65 };
